...
// Tof: Import only to access to a Database and MySQLDriver class
...
final class Routes: RouteCollection {
  func build(_ builder: RouteBuilder) throws {
    ...
    builder.get {
      ...
      // Tof: Access directly to the MySQL driver
      if let lDb = Database.default?.driver as? MySQLDriver.Driver {
